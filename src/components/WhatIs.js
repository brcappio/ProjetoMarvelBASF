function WhatIs() {
    return(
        <div className="whatis-container">
            <div className="whatis-title-container">
                <h2 className="whatis-title">What Is Marvel Snap?</h2>
            </div>
            <div className="whatis-text-container">
                    <div className="whatis-text">
                        ...
                        <br />
                        <p>For more info head over to: <a href="https://pt.wikipedia.org/wiki/Marvel_Snap" target="_blank" rel="noopener noreferrer">https://pt.wikipedia.org/wiki/Marvel_Snap</a></p>
                    </div>
            </div>
        </div>
